import{j as i}from"./index-a75c2214.js";import{S as t}from"./SyntaxHighlighter-39525d8f.js";import"./objectWithoutProperties-8e2777d0.js";import"./objectWithoutPropertiesLoose-4f48578a.js";import"./toConsumableArray-d3906663.js";import"./extends-98964cd2.js";const a=()=>i.jsxs(i.Fragment,{children:[i.jsxs("p",{children:["To initialize the app direction, simply set"," ",i.jsx("code",{children:"direction"})," field as",i.jsx("code",{children:"'ltr'"})," or ",i.jsx("code",{children:"'rtl'"})," in"," ",i.jsx("code",{children:"src/configs/theme.config.ts"}),". For example:"]}),i.jsx(t,{language:"ts",children:`export const themeConfig = {
	...
	direction: 'rtl'
