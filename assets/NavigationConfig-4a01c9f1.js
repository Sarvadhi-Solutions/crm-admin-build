import{j as e}from"./index-c3e9fa7c.js";import{S as t}from"./SyntaxHighlighter-dfe70d12.js";import{D as n}from"./DemoComponentApi-e808b075.js";import"./objectWithoutProperties-8e2777d0.js";import"./objectWithoutPropertiesLoose-4f48578a.js";import"./toConsumableArray-ab33ca8c.js";import"./extends-98964cd2.js";import"./index-b1456952.js";import"./index.esm-e2831cf6.js";import"./index-6f0be7c6.js";const u=()=>e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["We form our navigation structure as array of objects & render it into UI eventually. You can change or customize the app navigation very easily by accessing"," ",e.jsx("code",{children:"src/configs/navigation.config/index.ts"})]}),e.jsx("p",{children:"Here is the type for a single menu item"}),e.jsx(t,{language:"ts",children:`interface NavigationTree {
    key: string;
    path: string;
...
`}),e.jsxs("p",{children:["Now the corresponding menu item will render"," ",e.jsx("code",{children:"FaBeer"})," as the menu icon."]})]})]});export{u as default};
