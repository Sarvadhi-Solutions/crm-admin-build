import{j as e}from"./index-4bd6b7b3.js";import{S as n}from"./SyntaxHighlighter-d5a055b8.js";import"./objectWithoutProperties-8e2777d0.js";import"./objectWithoutPropertiesLoose-4f48578a.js";import"./toConsumableArray-3723ed4f.js";import"./extends-98964cd2.js";const i=()=>e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["Elstar use"," ",e.jsx("a",{href:"https://react.i18next.com/",target:"_blank",rel:"noopener noreferrer",children:"react-i18next"})," ","for internationalization, you can find corresponding files can be found in ",e.jsx("code",{children:"src/locales/*"})]}),e.jsxs("div",{className:"mt-10",id:"translatingText",children:[e.jsx("h5",{children:"Translating text"}),e.jsxs("p",{className:"mt-1",children:["One of the simplest usage for translate text is using"," ",e.jsx("code",{children:"useTranslate"})," hook provided by react-i18next."]}),e.jsx(n,{language:"tsx",children:`import { useTranslation } from 'react-i18next'
